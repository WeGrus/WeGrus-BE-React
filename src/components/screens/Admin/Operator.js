...
//   }
  ...
  return (
    ...
    null
        ...
        <InforBar>
          <InforContents>
            <Number onClick={(e) => { handleNumber() }}>번호<InforSelection  ></InforSelection></Number>
            <Grade onClick={(e) => { handleSort("Grade") }}>학년<InforSelection ></InforSelection></Grade>
            <StudentId onClick={(e) => { handleSort("StudentId") }}>학번<InforSelection ></InforSelection></StudentId>
            <PhoneNumber onClick={(e) => { handleSort("PhoneNumber") }} post>연락처<InforSelection ></InforSelection></PhoneNumber>
            <Name onClick={(e) => { handleSort("Name") }}>이름<InforSelection ></InforSelection></Name>
            <Role>회원직책</Role>
            <Attendance onClick={(e) => { handleSort("Attendance") }}>학적<InforSelection ></InforSelection></Attendance>
            <Gender onClick={(e) => { handleSort("Gender") }}>성별<InforSelection ></InforSelection></Gender>
