...
import Modal from "./ModalGroup.js";
...
function OptionButton(props){
    const {id, show, setShow, data, groupId} = props;
                ...
                {(show === id) ?
                    <>
                        <ClickSection>
                            ...
                            <ClickBtn onClick={() => {setModal(Delegate) }}>소모임장 위임</ClickBtn>
                        </ClickSection>
                        {(showModal==true)?
                        <Modal showModal={showModal} setShowModal={setShowModal} setShow={setShow} modalOption={modalOption} modalInfor={modalInfor} groupId={groupId}/>
                        :
                        null
                        }
                    </>
